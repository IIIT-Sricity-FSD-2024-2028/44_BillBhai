// Port of scripts/validation.js - client-side validation for the customer /
// fulfillment details captured by the POS wizard.

export function validateCustomerStep(input, phoneArg) {
